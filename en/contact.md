...
<main class="container contact">
  ...
  <section class="contact-grid">
    <article class="card">
      <h2>Reach Us</h2>
      <p>Veer Patta Public School, Karmal Road, Nokha, Rajasthan 334803</p>
    ...
    <article class="card">
      ...
      <p><a class="btn btn-secondary" href="https://maps.google.com/?q=Veer+Patta+Public+School+Nokha" target="_blank" rel="noopener">View on Map</a></p>
    </article>

    <article class="card">
      <h2>Transport Routes</h2>
      <ul>
        <li>Nokha Town ↔ School (morning & afternoon)</li>
