...
<main class="container about">
  <section class="about-hero">
    <h1>About Veer Patta Public School</h1>
    <p>Rooted in values. Focused on modern learning. Serving families since 1994.</p>
  </section>
  ...
  <section class="about-mission">
    <h2>Our Mission</h2>
    <p>To nurture confident, disciplined, and compassionate learners through strong academics and character building.</p>
  </section>
  ...
  <section class="about-values">
    <h2>Core Values</h2>
    <ul>
      <li>Discipline with empathy</li>
      <li>Academic integrity</li>
      <li>Service & citizenship</li>
      <li>Creativity & curiosity</li>
    </ul>
  </section>
</main>
